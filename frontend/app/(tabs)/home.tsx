...
export default function HomeScreen() {
  ...
  useEffect(() => {
    // Bouncing animation for the balance card
    Animated.loop(
      Animated.sequence([
      ...
      >
        ...
        <View style={styles.aiBanner}>
          ...
          <View style={styles.aiBannerContent}>
            <Text style={styles.aiBannerTitle}>AI Fraud Detection Active</Text>
            <Text style={styles.aiBannerText}>All transactions monitored 24/7</Text>
          </View>
        </View>

        {/* Recent Transactions with Dummy Data */}
            ...
            <View key={tx.id} style={styles.transactionCard}>
              <View style={styles.transactionLeft}>
                ...
                <View>
                  ...
                  {tx.riskLevel === 'HIGH' && (
                    <Text style={styles.txWarning}>⚠️ Unusual pattern detected</Text>
                  )}
                </View>
              </View>
              <View style={styles.transactionRight}>
                ...
                <View style={[styles.riskBadge, { backgroundColor: `${tx.color}20` }]}>
                  <Text style={[styles.riskText, { color: tx.color }]}>
                    {getRiskEmoji(tx.riskLevel)} {tx.riskLevel}
                  </Text>
                </View>
              </View>
            </View>
        ...
        <View style={styles.tipsCard}>
          ...
          <Text style={styles.tipText}>Tip: Never share your OTP or PIN with anyone!</Text>
        </View>
      </ScrollView>
    </SafeAreaView>
  );
